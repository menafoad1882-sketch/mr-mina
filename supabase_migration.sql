...
create table if not exists academic_years (id bigint generated by default as identity primary key);
create table if not exists terms (id bigint generated by default as identity primary key);
create table if not exists groups (id bigint generated by default as identity primary key);
create table if not exists students (id bigint generated by default as identity primary key);
create table if not exists enrollments (id bigint generated by default as identity primary key);
create table if not exists group_transfers (id bigint generated by default as identity primary key);
create table if not exists sessions (id bigint generated by default as identity primary key);
create table if not exists attendance (id bigint generated by default as identity primary key);
create table if not exists exams (id bigint generated by default as identity primary key);
create table if not exists questions (id bigint generated by default as identity primary key);
create table if not exists question_bank (id bigint generated by default as identity primary key);
create table if not exists results (id bigint generated by default as identity primary key);
create table if not exists exam_attempts (id bigint generated by default as identity primary key);
create table if not exists reminders (id bigint generated by default as identity primary key);
create table if not exists booklets (id bigint generated by default as identity primary key);
create table if not exists wa_logs (id bigint generated by default as identity primary key);
create table if not exists parents (id bigint generated by default as identity primary key);
create table if not exists parent_students (id bigint generated by default as identity primary key);
create table if not exists absence_alerts (id bigint generated by default as identity primary key);
create table if not exists settings (key text primary key);

-- 1-ب) تحويل عمود id في الجداول القديمة إلى توليد تلقائي (identity)
--     حتى يمكن رفع الصفوف بلا id فيولّده Supabase (يمنع null id / تكرار pkey).
--     آمن و idempotent: يتخطّى لو كان identity بالفعل، ويضبط التسلسل على أكبر id.
do $$
begin
  if exists (select 1 from information_schema.columns
    ...
    begin
      alter table academic_years alter column id add generated by default as identity;
    exception when others then null;
    end;
    perform setval(pg_get_serial_sequence('academic_years','id'),
                   greatest(coalesce((select max(id) from academic_years),1),1));
  end if;
end $$;
do $$
begin
  if exists (select 1 from information_schema.columns
            where table_name='terms' and column_name='id'
              and is_identity='NO') then
    begin
      alter table terms alter column id add generated by default as identity;
    exception when others then null;
    end;
    perform setval(pg_get_serial_sequence('terms','id'),
                   greatest(coalesce((select max(id) from terms),1),1));
  end if;
end $$;
do $$
begin
  if exists (select 1 from information_schema.columns
    ...
    perform setval(pg_get_serial_sequence('groups','id'),
...
begin
  if exists (select 1 from information_schema.columns
    ...
    perform setval(pg_get_serial_sequence('students','id'),
                   greatest(coalesce((select max(id) from students),1),1));
  end if;
end $$;
do $$
begin
  if exists (select 1 from information_schema.columns
    ...
    perform setval(pg_get_serial_sequence('enrollments','id'),
                   greatest(coalesce((select max(id) from enrollments),1),1));
  end if;
end $$;
do $$
begin
  if exists (select 1 from information_schema.columns
            where table_name='group_transfers' and column_name='id'
              and is_identity='NO') then
    begin
      alter table group_transfers alter column id add generated by default as identity;
    exception when others then null;
    end;
    perform setval(pg_get_serial_sequence('group_transfers','id'),
                   greatest(coalesce((select max(id) from group_transfers),1),1));
  end if;
end $$;
do $$
begin
  if exists (select 1 from information_schema.columns
    ...
    perform setval(pg_get_serial_sequence('sessions','id'),
...
begin
  if exists (select 1 from information_schema.columns
            where table_name='attendance' and column_name='id'
              and is_identity='NO') then
    begin
      alter table attendance alter column id add generated by default as identity;
    exception when others then null;
    end;
    perform setval(pg_get_serial_sequence('attendance','id'),
                   greatest(coalesce((select max(id) from attendance),1),1));
  end if;
end $$;
do $$
begin
  if exists (select 1 from information_schema.columns
    ...
    perform setval(pg_get_serial_sequence('exams','id'),
                   greatest(coalesce((select max(id) from exams),1),1));
  end if;
end $$;
do $$
begin
  if exists (select 1 from information_schema.columns
            where table_name='questions' and column_name='id'
              and is_identity='NO') then
    begin
      alter table questions alter column id add generated by default as identity;
    exception when others then null;
    end;
    perform setval(pg_get_serial_sequence('questions','id'),
                   greatest(coalesce((select max(id) from questions),1),1));
  end if;
end $$;
do $$
begin
  if exists (select 1 from information_schema.columns
            where table_name='question_bank' and column_name='id'
              and is_identity='NO') then
    begin
      alter table question_bank alter column id add generated by default as identity;
    exception when others then null;
    end;
    perform setval(pg_get_serial_sequence('question_bank','id'),
                   greatest(coalesce((select max(id) from question_bank),1),1));
  end if;
end $$;
do $$
begin
  if exists (select 1 from information_schema.columns
            where table_name='results' and column_name='id'
              and is_identity='NO') then
    begin
      alter table results alter column id add generated by default as identity;
    exception when others then null;
    end;
    perform setval(pg_get_serial_sequence('results','id'),
                   greatest(coalesce((select max(id) from results),1),1));
  end if;
end $$;
do $$
begin
  if exists (select 1 from information_schema.columns
            where table_name='exam_attempts' and column_name='id'
              and is_identity='NO') then
    begin
      alter table exam_attempts alter column id add generated by default as identity;
    exception when others then null;
    end;
    perform setval(pg_get_serial_sequence('exam_attempts','id'),
                   greatest(coalesce((select max(id) from exam_attempts),1),1));
  end if;
end $$;
do $$
begin
  if exists (select 1 from information_schema.columns
    ...
    perform setval(pg_get_serial_sequence('reminders','id'),
                   greatest(coalesce((select max(id) from reminders),1),1));
  end if;
end $$;
do $$
begin
  if exists (select 1 from information_schema.columns
            where table_name='booklets' and column_name='id'
              and is_identity='NO') then
    begin
      alter table booklets alter column id add generated by default as identity;
    exception when others then null;
    end;
    perform setval(pg_get_serial_sequence('booklets','id'),
                   greatest(coalesce((select max(id) from booklets),1),1));
  end if;
end $$;
do $$
begin
  if exists (select 1 from information_schema.columns
            where table_name='wa_logs' and column_name='id'
              and is_identity='NO') then
    begin
      alter table wa_logs alter column id add generated by default as identity;
    exception when others then null;
    end;
    perform setval(pg_get_serial_sequence('wa_logs','id'),
                   greatest(coalesce((select max(id) from wa_logs),1),1));
  end if;
end $$;
do $$
begin
  if exists (select 1 from information_schema.columns
            where table_name='parents' and column_name='id'
              and is_identity='NO') then
    begin
      alter table parents alter column id add generated by default as identity;
    exception when others then null;
    end;
    perform setval(pg_get_serial_sequence('parents','id'),
                   greatest(coalesce((select max(id) from parents),1),1));
  end if;
end $$;
do $$
begin
  if exists (select 1 from information_schema.columns
            where table_name='parent_students' and column_name='id'
              and is_identity='NO') then
    begin
      alter table parent_students alter column id add generated by default as identity;
    exception when others then null;
    end;
    perform setval(pg_get_serial_sequence('parent_students','id'),
                   greatest(coalesce((select max(id) from parent_students),1),1));
  end if;
end $$;
do $$
begin
  if exists (select 1 from information_schema.columns
            where table_name='absence_alerts' and column_name='id'
              and is_identity='NO') then
    begin
      alter table absence_alerts alter column id add generated by default as identity;
    exception when others then null;
    end;
    perform setval(pg_get_serial_sequence('absence_alerts','id'),
                   greatest(coalesce((select max(id) from absence_alerts),1),1));
  end if;
end $$;
